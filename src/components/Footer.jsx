            ...
            <div className="col-md-4 text-light">
                ...
                <div className="d-flex justify-content-center mb-3">
                    <a href="https://facebook.com" className="mx-2">
                        <img src="images/facebook.jfif" alt="Facebook" className="social-pictures rounded-circle" />
                    </a>
                    <a href="https://instagram.com" className="mx-2">
                        <img src="images/instagram.jfif" alt="Instagram" className="social-pictures rounded-circle" />
                    </a>
                </div>
